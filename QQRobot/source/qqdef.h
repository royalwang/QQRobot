...
struct qqclient;
extern void buddy_msg_callback ( struct qqclient* qq, uint uid, time_t t, char* msg, qqmessage* pMsg );
extern void qun_msg_callback ( struct qqclient* qq, uint uid, uint int_uid, time_t t, char* msg );


extern void buddy_add_callback ( struct qqclient* qq, uint uid, int nType );
extern void qun_approve_apply_to_qun ( struct qqclient* qq );
extern void qun_delete_from_qun ( struct qqclient* qq );
